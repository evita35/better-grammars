 ...
 * @author Eva
 */
public class AcCompress_AdaptiveCount {
    ...
    public static void main(String[] args) {
       ...
       // rnaPrimSeq="AUCAUACCGUAU";
        ...
        ENCODE_ADAPTIVE_PROB rnaEncode2 = new ENCODE_ADAPTIVE_PROB(rnaPrimSeq, dotBrackString);
        ...
        DECODE_ADAPTIVE_PROB rnaDecode2 = new DECODE_ADAPTIVE_PROB(binaryCode2);

 ...
 * @author Juluis
 */
public class ENCODE_ADAPTIVE_PROB {
    String rnaPS;
    String dotBrack;
    ...
    public ENCODE_ADAPTIVE_PROB (String rnaPS1, String dotBrack1){//initialising variables
        rnaPS=rnaPS1;
        dotBrack = dotBrack1;
                 
        DERIVATION_4_ADAPTIVE_PROB rnaDerivative = new DERIVATION_4_ADAPTIVE_PROB(rnaPS,dotBrack);//creates object to read through the rna primary and secondary structure and start the subdivisions
        ...
        //binaryCode=encodeCounter()+binaryCode;
   ...
   String encodeCounter (){//counter is encoded using elias gamma codes
       Production_Rule_Frequency_Adapt PRF = new Production_Rule_Frequency_Adapt(rnaPS, dotBrack);

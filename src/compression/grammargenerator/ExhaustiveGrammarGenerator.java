...
public class ExhaustiveGrammarGenerator {
    ...
    private static void testingSRF() {
        ...
        SRFParser testingSRFParser = new SRFParser(simpleGrammar,null);
    ...
    private static void testingAutoGeneratedGrammars(int n){
        AutoGeneratedGrammars ag = new AutoGeneratedGrammars(n);
        AutoGeneratedGrammars.printMap(ag.generateRules());
    }
    ...
    private static void sortByAverageCompressedBits(String folderNameForGrammars, String folderNameForRnas) throws FileNotFoundException {

...
public class AbstractGrammarExplorer {
	...
	public AbstractGrammarExplorer(final int nNonterminals) {
		...
		AutoGeneratedGrammars autoGeneratedGrammars = new AutoGeneratedGrammars(this.nNonterminals); // AutoGeneratedGrammars uses nNonterminals-1 ( subtracting one is no longer necessary ...)
		allPossibleRules = autoGeneratedGrammars.generateRules().values().toArray(new Rule[0]);
	...
	public static class GrammarWithScore implements Comparable<RandomGrammarExplorer.GrammarWithScore> {
		...
		public int compareTo(final GrammarWithScore o) {
			return Double.compare(avgBitsPerBase, o.avgBitsPerBase);
		}

...
//            System.out.println("Compressions <dataset> <training-dataset> <with-NCR> <rule-probability-model> <grammar-folder>");
            ...
            switch (model) {
                ...
                case STATIC_FROM_FILE:
                    ...
                    staticRuleProbs = Collections.unmodifiableMap(
                            G.readRuleProbs(trainingDataset.getRuleProbsForAutoGenGrammar(G)));
                    break;
                default:
                ...
                .forEach((rnaWithStructure) -> {
                    ...
                    switch (model) {
                        ...
                        case STATIC_FROM_FILE:
                            ...
                            break;
                        case SEMI_ADAPTIVE:
                            ruleProbModel = new SemiAdaptiveRuleProbModel(G, G.getStartSymbol(), rnaWithStructure);
                            break;
                        case ADAPTIVE:

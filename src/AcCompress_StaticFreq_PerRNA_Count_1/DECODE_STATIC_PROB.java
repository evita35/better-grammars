 ...
 * @author EVA
 */
public class DECODE_STATIC_PROB {
    ...
    DECODE_STATIC_PROB(String binCode){//constructor initialised binCode# 
        binaryCode=binCode;
        DECODE_STATIC_PROBABILITIES RNA_Decode = new DECODE_STATIC_PROBABILITIES(binaryCode);
         ...
         sumSProbs2=RNA_Decode.getSumSProbs();//sumLProbs1 contains the boundaries of the intervals of the events
                                        //S->LS and S->e
         delimeter = RNA_Decode.getDelimeter();
         binaryCode= binaryCode.substring(delimeter, binaryCode.length());
    }
